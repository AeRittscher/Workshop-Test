...
custom_palette_Anne<-c("aquamarine4","blanchedalmond","burlywood3","cadetblue",
...
#showCols <- function(cl=colors(), bg = "grey",
    ...
    #require("grid")
    #grid.newpage(); vp <- viewport(w = .96, h = .92)
    #grid.rect(gp=gpar(fill=bg))
    #grid.text(cm, x = col(cm)/m, y = rev(row(cm))/m, rot = rot,
     #         vp=vp, gp=gpar(cex = cex, col = cm))
  #}

#showCols(bg="gray20",cl=colors()[600:700], rot=30, cex=0.9)
...
unique(filtered_df$Phylum)#shows that there are still 42 groups included
...
theme(
    legend.text = element_text(size = 5),  # Adjusts text size in the legend
    legend.key.size = unit(0.25, "cm")) # Adjusts th
```
